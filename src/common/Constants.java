...
public class Constants {
    ...
    public static final String OPENUNIVKOR_TXT = "개설대학";
    ...
    public static final String TIMEKOR_TXT = "요일 및 강의시간";
    public static final String CLASSROOMKOR_TXT = "강의실";
    public static final String PROFESSORKOR_TXT = "교수명";
    public static final String NUMBERKOR_TXT = "신청인원";
    ...
    public static final String NUMBER_TXT = "count";
